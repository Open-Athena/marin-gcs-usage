...
def test_served_prefixes_are_the_snapshot_and_layer2_dirs():
    assert P.served_prefixes("2026-09-23T1201") == ["snapshots/cw/2026-09-23T1201/", "cw-l2/2026-09-23T1201/"]
    assert P.served_prefixes("2026-09-23", subdir="r2", layer2_root="l2") == ["snapshots/r2/2026-09-23/", "l2/2026-09-23/"]
